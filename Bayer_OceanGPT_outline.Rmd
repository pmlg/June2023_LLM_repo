...
human-like behaviour in rocks. Talk a bit about stochastic parrots (Bender paper). ChatGPT *probably* (IMHO) cannot generalise/find novel ideas. I've played around a lot with trying to get OceanGPT to find novel patterns in our data, usually terrible at this. Only good if I get an ecologist or a fisheries scientist to ask their questions; ChatGPT has so far failed to come up with its own questions when prompted to. Human needed to understand and generalise. I don't see any progress in LLMs towards that end.
